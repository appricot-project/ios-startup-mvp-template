...
public struct CreateStartupMutation: GraphQLMutation {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"mutation CreateStartup($ownerEmail: String!, $title: String!, $description: String!, $location: String!, $categoryId: ID!) { createStartup( data: { ownerEmail: $ownerEmail title: $title description: $description location: $location category: $categoryId } ) { __typename documentId ownerEmail title description location createdAt updatedAt publishedAt category { __typename title categoryId } ImageURL { __typename url } } }"#
    ))
