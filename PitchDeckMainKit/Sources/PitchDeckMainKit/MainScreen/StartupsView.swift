...
struct StartupsView: View {
    ...
    private var content: some View {
        ...
        case .loaded(let startUps, let categories, let selectedCategoryId, let hasMore):
            return main(filteredStartups: startUps, categories: categories, selectedCategoryId: selectedCategoryId, hasMore: hasMore).eraseToAnyView()
        case .loadingMore:
            return LoadingView().eraseToAnyView()
    ...
    private func main(filteredStartups: [StartupItem]? = nil, categories: [CategoryItem]? = nil, selectedCategoryId: Int? = nil, hasMore: Bool = false) -> some View {
        NavigationView {
            ScrollView {
